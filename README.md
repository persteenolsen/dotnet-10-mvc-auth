# dotnet-10-mvc-authentication

ASP.NET Core Identity MVC Web Application by .NET 10 with Individual Accounts towards a SQLite Database
...
dotnet tool install --global dotnet-aspnet-codegenerator --version 10.0.0-rc.1.25458.5
